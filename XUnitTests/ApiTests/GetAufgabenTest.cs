...
namespace XUnitTests.ApiTests
{
    public class GetAufgabenTest
    {
        ...
        public GetAufgabenTest()
        {
            ...
            _mockWebAppContext = new Mock<WebAppContext>(DbContextOptions<WebAppContext> options);
            ...
            var aufgabenList = new List<Aufgabe>
        {
            ...
            var mockAufgabenDbSet = new Mock<DbSet<Aufgabe>>(MockBehavior.Strict); // Create a mock DbSet
